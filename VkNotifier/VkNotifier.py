...
class VkNotifier:
    ...
    def check_for_new_messages(self) -> None:
        """
    ...
    def login_throw_user(self) -> None:
        """
    ...
    def login_throw_group(self) -> None:
        """
    ...
    def send_message_to_dev(self, text: str) -> None:
        """
    ...
    def send_message_to_chat(self, text: str) -> None:
        """
